...
if (window.innerWidth > 1199) {
    ...
    function scene9() {
        ...
        tl.fromTo('.d-show .slide-2-txt-box .btn .span-reveal img.app-store,.d-show .slide-2-txt-box .btn .span-reveal img.google-play,.qr-box .span-reveal img,.qr-container .span-reveal', {
            yPercent: 200,
            // scale: 0,
            opacity: 0
            // duration: 2,
    ...
    function slide5_scence_3n() {
        ...
        tl.fromTo('.d-show #plans-main2  .yellow', {
            ...
            // duration: 100,
            // onComplete: () => {
            //     gsap.to('.d-show #plans-main2  .yellow', {
            //         xPercent: 0
            //     })
            // }
    ...
    // gsap.set("#plans-main2 .yellow", { xPercent: 5, opacity: 0 });
    gsap.set("#plans-main2 .green", { yPercent: 99, opacity: 0 });
    gsap.set("#plans-main2 .purple", { yPercent: 114, opacity: 0 });
    gsap.set("#plans-main2 .indigo", { yPercent: 121, opacity: 0 });
    ...
    let purpleHandler = new gsap.timeline({})
    var heroDesk = gsap.timeline();
    heroDesk.to("#plans-main2 .green", {
        //  autoAlpha: 1,
        yPercent: '-=100',
        duration: 10,
        opacity: 1,
    ...
    var heroDesk2 = gsap.timeline()
        .to("#plans-main2 .purple", {
            //  autoAlpha: 1,
            yPercent: '-=100',
            duration: 10,
            opacity: 1,
    ...
    var heroDesk3 = gsap.timeline()
        .to("#plans-main2 .indigo", {
            //  autoAlpha: 1,
            yPercent: '-=100',
            duration: 10,
            stagger: 20,
            ...
            // onComplete: () => {
            //     purpleHandler.to('#plans-main2 .yellow', {
            //         xPercent: 5
            //     })
            //     purpleHandler.to('#plans-main2 .green', {
            //         xPercent: 10
            //     })
            //     purpleHandler.to('#plans-main2 .purple', {
            //         xPercent: 15
            //     })
            // },
            // onReverseComplete: () => {
    ...
    let masterNode = new gsap.timeline({
        // stagger: 100,
        scrollTrigger: {
            onEnter: () => {
                ScrollTrigger.refresh()
    ...
    document.getElementById('why-rox-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('why-rox'), { force: true, offset: -111 })
    });

    document.getElementById('vouchers-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('vouchers'), { force: true, offset: -111 })
    });
    document.getElementById('referral-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('referral'), { force: true, offset: -111 })
    });



    document.getElementById('plans-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('plans'), { force: true })
    });

    document.getElementById('faqs-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('faqs'), { force: true })
    });

    document.getElementById('apply-now-nav').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('apply-now'), { force: true })
    });
    ...
    // FOOTER START
    document.getElementById('why-rox-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('why-rox'), { force: true, lock: true })
    });

    document.getElementById('vouchers-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('vouchers'), { force: true, lock: true })
    });
    document.getElementById('referral-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('referral'), { force: true, lock: true })
    });



    document.getElementById('plans-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('plans'), { force: true, lock: true })
    });

    document.getElementById('faqs-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('faqs'), { force: true, lock: true })
    });

    document.getElementById('apply-now-navF').addEventListener('click', (e) => {
        // Scroll to 100vh with native window.scroll
        e.preventDefault()
        lenis.scrollTo(document.getElementById('apply-now'), { force: true, lock: true })
    });
    ...
    // Setup Modal 1
    setupModal("planModal", "planBtn", "closePlan");

    // Setup Modal 2
    setupModal("planModalP2", "planBtnP2", "closePlanP2");
    setupModal("planModalP3", "planBtnP3", "closePlanP3");
    setupModal("planModalP4", "planBtnP4", "closePlanP4");
    setupModal("faqOneModal", "faqOneBtn", "closePlanOne");
    setupModal("genTermsModal", "genTermsBtn", "closeGenTerms");
    setupModal("genTermsModalF", "genTermsBtnF", "closeGenTermsF");

    // modal cODEEND
    // DESKTOP HTML SCRITPS END
}
    ...
    lenisMob.on('scroll', ScrollTrigger.update)
    console.log("MOB")
    ...
    function scene2m() {
        ...
        tl.fromTo(".m-show .char-slide1 img",
            { x: 0, duration: 2 },
            { x: 20, duration: 8, repeat: -1, yoyo: true })
    }
    function scene3m() {
        let tl = gsap.timeline();
    ...
    var navBar_mob_master = gsap.timeline()
    ...
    function scene9nm() {
        ...
        tl.fromTo('.m-show .slide2-graphic1',
            {
                opacity: 0,
                xPercent: 120,
        ...
        tl.fromTo('.m-show .slide2-graphic2',
            {
                opacity: 0,
                xPercent: -120,
        ...
        tl.fromTo('.m-show .slide2-graphic3',
            {
                opacity: 0,
                xPercent: 120,
        ...
        tl.fromTo('.m-show .slide2-graphic4',
            {
                opacity: 0,
                xPercent: -120,
        ...
        tl.fromTo('.m-show .slide2-graphic5',
            {
                opacity: 0,
                xPercent: 120,
    ...
    function scene10m() {
        ...
        tl.fromTo('.m-show .slide2-graphic1,.m-show .slide2-graphic2 ,.m-show .slide2-graphic3,.m-show .slide2-graphic4 ,.m-show .slide2-graphic5,.m-show .slide2-graphic6', {
            yPercent: 0
        },
            {
                yPercent: -600,
    ...
    // slide2Master.add(sceneSlidemove2())
    slide2Masterm.add(scenceColorChange2m())
        .add(scene7m())
        .add(scene8m())
        .add(scene9m())
        .add(scene9nm(), "+=50")
    ...
    function scene13nm() {
        ...
        tl.fromTo('.m-show .slide3-graphic2',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide3-graphic3',
            {
                opacity: 0,
                xPercent: 120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide3-graphic4 ',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide3-graphic5',
            {
                opacity: 0,
                xPercent: 120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide3-graphic6',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
    ...
    function scene17nm() {
        ...
        tl.fromTo('.m-show .slide4-graphic1',
            {
                opacity: 0,
                xPercent: 120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide4-graphic2',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide4-graphic3',
            {
                opacity: 0,
                xPercent: 120,
                // duration: 2,
    ...
    function scene21nm() {
        ...
        tl.fromTo('.m-show .slide5-graphic1',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide5-graphic2',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide5-graphic3',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
    ...
    function scene25nm() {
        ...
        tl.fromTo('.m-show .slide6-graphic1',
            {
                opacity: 0,
                xPercent: 120,
                // duration: 2,
        ...
        tl.fromTo('.m-show .slide6-graphic2',
            {
                opacity: 0,
                xPercent: -120,
                // duration: 2,
    ...
    function scene26m() {
        ...
        tl.fromTo('.m-show .slide6-graphic1,.m-show .slide6-graphic2', {
            yPercent: 0
        },
            {
                yPercent: -300,
    ...
    gsap.set(".m-show .slide-5", { xPercent: 0, yPercent: 0 });
    gsap.set(".turbo-slider-bx", { xPercent: 0, yPercent: 0 });
    ...
    //         pin: true,
    //         //    pinSpacing: true,
    //         start: `${window.innerHeight <= 667 ? 'center 10%' : window.innerHeight > 900 ? '55% 0%' : '40% 10%'}`,
    //         end: "+=100 +=50",
    //         scrub: 1,
    //         markers: true
    //     },
    ...
    const cards = document.querySelectorAll('.m-show .slide-5 .turbo-slider-bx .cards');
    const header = document.querySelector('.m-show .slide-5');
    const charSlide5 = document.querySelector('.m-show .slide-5 .char-slide5');
    const ourDataPlan = document.querySelector('.m-show .slide-5 .our-data-plan');
    const paraSlidePinSwitcher = document.querySelector('.m-show .slide-5 .paraSlidePinSwitcher');
    // const paraSlidePinSwitcher = document.querySelector('.m-show .slide-5 . ');
    ...
    console.log(
        ourDataPlan.clientHeight - paraSlidePinSwitcher.clientHeight)
    console.log(
        charSlide5.clientHeight)
    gsap.timeline().to(".turbo-slider-bx .green,.turbo-slider-bx .purple,.turbo-slider-bx .indigo", {
        //  autoAlpha: 1,
        yPercent: '-=100',
        duration: 1.5,
        stagger: 1.5,
        ...
        scrollTrigger: {
            trigger: ".slide-5",
            start: `+=${charSlide5.clientHeight + (ourDataPlan.clientHeight * (window.innerHeight <= 667 ? 1.1 : window.innerHeight <= 740 ? 1.15 : window.innerHeight <= 844 ? 0.8 : 0.1))} top`,
            pin: true,
