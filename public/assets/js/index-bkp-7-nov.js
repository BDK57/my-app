...
function scene13() {
    ...
    tl.fromTo('.d-show .slide3-nav>.span-reveal p', {
        xPercent: -200,
        scale: 0,
        opacity: 0
        // duration: 2,
...
function sceneSlidemove6() {
    ...
    tl.fromTo('.d-show .slide-6', { y: -540, duration: 2, opacity: 1 }, {
        y: -675, duration: 10, opacity: 1, ease: "expo",
        scrollTrigger: {
            trigger: ".d-show .slide-6",
            scroller: "body",
            // duration: 0.05,
...
function sceneSlidemove7() {
    let tl = gsap.timeline();
    tl.fromTo('.d-show .slide-7', { y: -675, duration: 2, opacity: 1 }, {
        y: -805, duration: 10, opacity: 1, ease: "expo",
        scrollTrigger: {
...
gsap.set("#plans-main2 .green", { yPercent: 100, xPercent: 35, opacity: 0 });
gsap.set("#plans-main2 .purple", { yPercent: 105, xPercent: 40, opacity: 0 });
gsap.set("#plans-main2 .indigo", { yPercent: 110, xPercent: 45, opacity: 0 });
...
var hero = gsap.timeline().to("#plans-main2 .green,#plans-main2 .purple,#plans-main2 .indigo", {
    //  autoAlpha: 1,
    yPercent: '-=100',
    duration: 10,
    stagger: 10,
